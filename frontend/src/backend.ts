...
export class Backend implements backendInterface {
    ...
    async addMenuItem(arg0: string, arg1: string, arg2: bigint, arg3: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async addTable(arg0: bigint, arg1: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createBill(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async createOrder(arg0: bigint, arg1: Array<OrderItem>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async makeReservation(arg0: bigint, arg1: string, arg2: bigint, arg3: Time): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.makeReservation(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markBillPaid(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markBillPaid(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeTable(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeTable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setTableOccupied(arg0: bigint, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setTableOccupied(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMenuItem(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: string): Promise<void> {
        if (this.processError) {
            try {
